...
- 主路径：`https://github.com/Jassy930/codex-game-operator-v7/issues/new?template=feedback.yml`
- 模板：`.github/ISSUE_TEMPLATE/feedback.yml`
- Label：`feedback`
- 标题：`玩家反馈：星尘工坊`
- 字段：前 60 秒哪里不清楚、当时想做什么、主要发生在哪一步、其他补充。
- 本地事件：`feedback_clicked`
- 存储键：`stardust-workshop-feedback-events-v1`
